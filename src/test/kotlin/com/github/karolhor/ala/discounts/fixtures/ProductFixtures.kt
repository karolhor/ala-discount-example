...
object ProductFixtures {
    val noDiscountProductEntity = ProductEntity(
    ...
    val quantityDiscountProductEntity = ProductEntity(
    ...
    val fixedDiscountProductEntity = ProductEntity(
    ...
    val mixedDiscountProductEntity = ProductEntity(
    ...
    val quantityDiscountEntity = DiscountEntity(
    ...
    val fixedDiscountEntity = DiscountEntity(
    ...
    val quantityForMixedDiscountEntity = DiscountEntity(
        id = UUID.fromString("7840c976-f05e-4db5-ba02-c1d1be924db8"),
        productId = mixedDiscountProductEntity.id,
        policy = DiscountPolicy.QUANTITY,
    )

    val fixedForMixedDiscountEntity = DiscountEntity(
        id = UUID.fromString("c12f92e0-0afb-4550-8da8-440922dace92"),
        productId = mixedDiscountProductEntity.id,
        policy = DiscountPolicy.FIXED,
    )

    val discountThreshold1to5Entity = DiscountThresholdEntity(
    ...
    val discountThreshold6to12Entity = DiscountThresholdEntity(
    ...
    val discountThreshold13toInfEntity = DiscountThresholdEntity(
    ...
    val fixedThresholdEntity = DiscountThresholdEntity(
    ...
    val mixedQuantityThresholdEntity = DiscountThresholdEntity(
    ...
    val mixedFixedThresholdEntity = DiscountThresholdEntity(
